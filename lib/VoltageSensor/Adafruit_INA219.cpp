...
void Adafruit_INA219::setCalibration_16V_10A()
{
  // VBUS_MAX = 16V        (Set to 16V)
  // VSHUNT_MAX = 0.16     (Assumes Gain 4, 160mV)
  // RSHUNT = 0.05         (Shunt resistor value in ohms)
  ...
  //
  // Since Max_Current > Max_Possible_I
  // Max_Current_Before_Overflow = MaxPossible_I
  ...
  //
  // Since Max_ShuntVoltage == VSHUNT_MAX
  // Max_ShuntVoltage_Before_Overflow = VSHUNT_MAX
  ...
  // Set multipliers to convert raw current/power values
  ina219_currentDivider_mA = 1000;   // Current LSB = 1mA per bit
  ina219_powerMultiplier_mW = 20.0f; // Power LSB = 20mW per bit
